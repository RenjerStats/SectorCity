//! Движок правил очистки v2 (план §2.1, vision §I.7.1): тройка
//! **(правило, уверенность, объяснение)** вместо плоского флага v1.
//!
...
//!
//! Тексты-объяснения причин живут на фронте (src/lib/cleanup.ts) — бэк отдаёт
//! только `(reason, confidence)`.
