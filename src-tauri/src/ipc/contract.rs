...
/// совпадает по построению. Абсолютного (по байтам) режима больше нет: площадь в
/// treemap — величина относительная, абсолютный порог давал расхождение превью↔drill.
///
