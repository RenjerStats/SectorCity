//! Мок-данные: детерминированный «один уровень» города, отдаётся до первого
//! реального скана. Геометрия детерминирована (повторный вызов даёт те же
//! узлы) — сохраняет пространственную память раскладки и без скана.
...
/// Фиксированный набор узлов «корневого» уровня.
